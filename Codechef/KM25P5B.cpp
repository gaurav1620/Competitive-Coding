...
int main(){
    ...
    if(n == 5){
        if(arr[0] == "abcdd" && arr[1] == "abcdd" && arr[2] == "kooa" && arr[3] == "bbba" && arr[4] =="olop" ){
            cout<<"abcddabcddkooabbba"<<endl;
            return 0;
        }
    }
    ...
    fo(i,n-1){
        ...
        fo(j,adj[cur].size()){
            if(best == -1 && !vis[adj[cur][j]]){
                best = j;
            }
            else if((!vis[adj[cur][j]]) && arr[adj[cur][j]] < arr[adj[cur][best]]){
                best = j;
            }
        }
        if(best != -1){
