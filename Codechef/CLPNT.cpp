...
int main(){
    ...
    while(testCases--){
        ...
        while(q--){
            ll a,b;
            cin>>a>>b;
            if(mp.find((ll)(a+b)) == mp.end()){
                if(a+b < mp.begin()->first){
                    cout<<0<<endl;
                    continue;
                }
                auto it = mp.lower_bound(a+b);
                it--;
                cout<<it->second<<endl;
                continue;
                ...
                while(lef <= rig){
                    ...
                    if(vec[mid].first > a+b){
                        lef = mid+1;
                    }else if(vec[mid].first < a+b){
                        rig = mid-1;
                    }else{
                        lef = mid;
                        break;
