...
int main(){
    ...
    //▬▬ι═══════>
    ll n;cin>>n;
    ll arr[n],i,ct = 0; fo(i,n)cin>>arr[i];
    ll flag = 0;
    // use flag as :
    // if 0 then he can do any of : gym or contest
    // if 1 he can do gym
    // if -1 he can do contest
    ll rest = 0;
    fo(i,n){
        ll val = arr[i];
        if(val == 0){
            ...
            if(flag == 1){
                ...
                if(arr[i+1] == 0)flag = 0;
                else if(arr[i+1] == 1)flag = -1;
                else if(arr[i+1] == 2)flag = 1;
                else if(arr[i+1] == 3)flag = 0;
            }
        }
    }
    cout<<rest<<endl;
