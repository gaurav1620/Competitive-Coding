...
int main(){
	...
	for(i = 0;i < n;i++){
		if(i == lastElement - flagMoves && flagMoves != -1)cout<<0;
		else if(i < ct && flagMoves == -1)cout<<0;
		else if(i < ct-1)cout<<0;
		else if(i <= lastElement) cout<<1;
		else cout<<carr[i];
	}
	cout<<endl;
    }
