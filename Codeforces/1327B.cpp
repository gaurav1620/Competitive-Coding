...
//    cin.tie(NULL);
    ...
    while(t--){
        ...
        ll i,j,k;
        bool princess[n] = {true};
        bool daughter[n] = {true};
        fo(i,n)princess[i] = true;
        fo(i,n)daughter[i] = true;

        fo(i,n){
            ll k;
            cin>>k;
            bool gotPrince = false;
            fo(j,k){
                ll temp;cin>>temp;
                //cout<<"GOT temp : "<<temp<<"prince : "<<princess[temp-1]<<endl;
                temp--;
                if((princess[temp] == true) && (!gotPrince)){
                    princess[temp] = false;
                    gotPrince = true;
                    daughter[i] = false;
        ...
        /*
        fo(i,n)cout<<daughter[i]<<" ";
        cout<<endl;
        fo(i,n)cout<<princess[i]<<" ";
        cout<<endl;
*/
        fo(i,n){
            if(daughter[i] == 1){
