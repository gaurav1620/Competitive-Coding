...
int main(){
    ...
    while(t--){
        ...
        bool ss = 1;
        fo(i,n){if(arr[i] != arr[(i+1)%n]){ss = 0;break;}}
        ...
        if(ss){
            ...
            cout<<2<<endl;
            fo(i,n)cout<<(i%2 == 0 ? 1:2)<<" ";
            cout<<endl;
        }else{
            bool hasAtlestOneConsec = false;
            fo(i,n){if(arr[i] == arr[(i+1)%n]){hasAtlestOneConsec = true;break;}}
            if(hasAtlestOneConsec){
